Lrn.service('AuthService', ["$rootScope", "$q", "$http", "$window", "$cookies", "$state", "ngDialog",
  ...
  this.register = function(data) {
    $http.defaults.headers.post["Content-Type"] = "application/json";
      ...
      $http({
        ...
        // url: 'http://localhost:8180/api/v1/users/register',
        data: data
  ...
  this.login = function(data) {
      $http.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded";
      var url = 'https://lrn-api.herokuapp.com/api/v1/users/login';
      // var url = 'http://localhost:8180/api/v1/users/login';
  ...
  this.updateUser = function(user_id) {
      ...
      $http({
        ...
        // url: 'http://localhost:8180/api/v1/users/' + user_id
      }).then(function(data){
